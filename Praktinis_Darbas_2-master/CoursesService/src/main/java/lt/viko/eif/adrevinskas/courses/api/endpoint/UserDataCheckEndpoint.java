package lt.viko.eif.adrevinskas.courses.api.endpoint;


import lt.viko.eif.adrevinskas.courses.api.models.GetUserDataCheckRequest;
import lt.viko.eif.adrevinskas.courses.api.models.GetUserDataCheckResponse;
import lt.viko.eif.adrevinskas.courses.api.services.UserDataCheckService;
...
public class UserDataCheckEndpoint {
    ...
    private static final String NAMESPACE = "http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck";
