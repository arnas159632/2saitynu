 ...
 * 
 */
@WebServiceClient(name = "UserDataCheckService", targetNamespace = "http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck", wsdlLocation = "http://localhost:8080/ws/userDataCheck.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERDATACHECKSERVICE_QNAME = new QName("http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck", "UserDataCheckService");
    ...
    public UserDataCheck getUserDataCheckSoap11() {
        return super.getPort(new QName("http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck", "UserDataCheckSoap11"), UserDataCheck.class);
    }
    ...
    public UserDataCheck getUserDataCheckSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck", "UserDataCheckSoap11"), UserDataCheck.class, features);
    }
