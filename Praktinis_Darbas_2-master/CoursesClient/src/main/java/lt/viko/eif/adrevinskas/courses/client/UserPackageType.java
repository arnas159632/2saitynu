 ...
 *         &lt;element name="dedicatedServers" type="{http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck}dedicatedServersType" maxOccurs="unbounded"/>
 *         &lt;element name="cloudServers" type="{http://www.Courses.lt/viko/eif/adrevinskas/courses/api/userDataCheck}cloudServersType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UserPackageType {
    ...
    @XmlElement(required = true)
    protected List<Courses> dedicatedServers;
    @XmlElement(required = true)
    protected List<TeacherType> cloudServers;
     ...
     * 
     */
    public List<Courses> getDedicatedServers() {
        if (dedicatedServers == null) {
            dedicatedServers = new ArrayList<Courses>();
        }
     ...
     * 
     */
    public List<TeacherType> getCloudServers() {
        if (cloudServers == null) {
            cloudServers = new ArrayList<TeacherType>();
        }
