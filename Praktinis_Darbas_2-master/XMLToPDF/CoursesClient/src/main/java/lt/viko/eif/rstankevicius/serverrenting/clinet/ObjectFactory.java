 ...
 * generated in the lt.viko.eid.adrevinskas.serverrenting.clinet package.
...
public class ObjectFactory {
    ...
    private final static QName _UserData_QNAME = new QName("http://www.ServerRenting.lt/viko/eif/adrevinskas/serverrenting/api/userDataCheck", "userData");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: lt.viko.eid.adrevinskas.serverrenting.clinet
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ServerRenting.lt/viko/eif/adrevinskas/serverrenting/api/userDataCheck", name = "userData")
